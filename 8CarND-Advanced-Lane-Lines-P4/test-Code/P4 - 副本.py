...
class Line():
    ...
    #改变两个地方，一个s用直方图均衡,一个用原通道 二、s的阈值(90-255，160-255)
    ...
    def get_curverad(self, leftx, lefty, rightx, righty, bias_pix, num=20):
        ...
        # Calculate the new radii of curvature  计算20个点的曲率
...
if __name__ == '__main__':
    ...
    white_output = 'pro直方图均衡165-255提高长度fit移动平均.mp4'
